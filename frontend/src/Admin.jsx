...
function Admin() {
    ...
    const onGallerySubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch('https://mackenziephotography-27f1cbfa0d47.herokuapp.com/profile', { // Correct URL
                method: 'POST',
                body: formData
            });
            if (response.ok) {
    ...
    const onBlogSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch('https://mackenziephotography-27f1cbfa0d47.herokuapp.com/blogpost', {
                method: 'POST',
                body: formData
            });
            if (response.ok) {
